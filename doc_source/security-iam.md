# Identity and Access Management for AWS DeepLens<a name="security-iam"></a>

AWS Identity and Access Management \(IAM\) is an AWS service that helps an administrator securely control access to AWS resources\. IAM administrators control who can be *authenticated* \(signed in\) and *authorized* \(have permissions\) to use AWS DeepLens resources\. IAM is an AWS service that you can use with no additional charge\.
...
How you use AWS Identity and Access Management \(IAM\) differs, depending on the work that you do in AWS DeepLens\.

**Service user** – If you use the AWS DeepLens service to do your job, then your administrator provides you with the credentials and permissions that you need\. As you use more AWS DeepLens features to do your work, you might need additional permissions\. Understanding how access is managed can help you request the right permissions from your administrator\. If you cannot access a feature in AWS DeepLens, see [Troubleshooting AWS DeepLens Identity and Access](security_iam_troubleshoot.md)\.

**Service administrator** – If you're in charge of AWS DeepLens resources at your company, you probably have full access to AWS DeepLens\. It's your job to determine which AWS DeepLens features and resources your employees should access\. You must then submit requests to your IAM administrator to change the permissions of your service users\. Review the information on this page to understand the basic concepts of IAM\. To learn more about how your company can use IAM with AWS DeepLens, see [How AWS DeepLens Works with IAM](security_iam_service-with-iam.md)\.

**IAM administrator** – If you're an IAM administrator, you might want to learn details about how you can write policies to manage access to AWS DeepLens\. To view example AWS DeepLens identity\-based policies that you can use in IAM, see [AWS DeepLens Identity\-Based Policy Examples](security_iam_id-based-policy-examples.md)\.
