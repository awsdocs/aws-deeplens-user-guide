# Set Up Your AWS DeepLens Development Environment<a name="deeplens-prerequisites"></a>
...
**Topics**
+ [Create an AWS Account](#deeplens-create-aws-account)
+ [Create an IAM User](#deeplens-create-iam-user)
+ [Set Up Required Permissions](#deeplens-required-iam-roles)
...
You use an AWS Identity and Access Management \(IAM\) user to specify to whom the IAM policies and roles apply\.
